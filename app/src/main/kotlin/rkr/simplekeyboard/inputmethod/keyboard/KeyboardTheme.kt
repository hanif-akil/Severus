    ...
    companion object {
        ...
        fun searchKeyboardThemeById(themeId: Int): KeyboardTheme? {
            for (theme in KEYBOARD_THEMES) {
                if (theme.mThemeId == themeId) return theme
            }
            return null
        }

        fun getDefaultKeyboardTheme(): KeyboardTheme = searchKeyboardThemeById(DEFAULT_THEME_ID)!!

        fun getKeyboardThemeName(themeId: Int): String {
            return searchKeyboardThemeById(themeId)!!.mThemeName
        }
        ...
        fun getKeyboardTheme(prefs: SharedPreferences): KeyboardTheme {
            ...
            if (themeIdString == null) return searchKeyboardThemeById(DEFAULT_THEME_ID)!!
            try {
