...
class KeyStylesSet(private val mTextsSet: KeyboardTextsSet) {
    ...
    private val mEmptyKeyStyle: KeyStyle = EmptyKeyStyle(mTextsSet)
    ...
    private inner class DeclaredKeyStyle(
    ...
    fun parseKeyStyleAttributes(keyStyleAttr: TypedArray, keyAttrs: TypedArray, parser: XmlPullParser) {
        ...
        val style = DeclaredKeyStyle(parentStyleName, mStyles)
    ...
    fun getKeyStyle(keyAttr: TypedArray, parser: XmlPullParser): KeyStyle {
        ...
        val style = mStyles[styleName]
            ?: throw XmlParseUtils.ParseException("Unknown key style: $styleName", parser)
        return style
    }

    companion object {
        private val TAG = KeyStylesSet::class.java.simpleName
