...
class KeyboardIconsSet {
    ...
    companion object {
        private const val TAG = "KeyboardIconsSet"
        ...
        const val NAME_CLIPBOARD_HISTORY_KEY = "clipboard_history_key"

        private val ATTR_ID_TO_ICON_ID = SparseIntArray()
        private val sNameToIdsMap = HashMap<String, Int>()
        private val ICON_NAMES: Array<String>
        ...
        private val NAMES_AND_ATTR_IDS = arrayOf(
            ...
            NAME_CLIPBOARD_HISTORY_KEY, R.drawable.sym_keyboard_clipboard
        )
        ...
        private fun isValidIconId(iconId: Int): Boolean = iconId in 0 until ICON_NAMES.size

        fun getIconName(iconId: Int): String = if (isValidIconId(iconId)) ICON_NAMES[iconId] else "unknown<$iconId>"

        fun getIconId(name: String): Int {
            return sNameToIdsMap[name] ?: throw RuntimeException("unknown icon name: $name")
        }
