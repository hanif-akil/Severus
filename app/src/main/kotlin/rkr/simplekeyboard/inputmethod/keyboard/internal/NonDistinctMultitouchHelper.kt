...
class NonDistinctMultitouchHelper {
    ...
    companion object {
        private val TAG = NonDistinctMultitouchHelper::class.java.simpleName
        private const val MAIN_POINTER_TRACKER_ID = 0

        private fun injectMotionEvent(action: Int, x: Float, y: Float, downTime: Long, eventTime: Long, tracker: PointerTracker, keyDetector: KeyDetector) {
