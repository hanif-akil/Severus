...
class InputAttributes(editorInfo: EditorInfo?, isFullscreenMode: Boolean) {
    ...
    init {
        mTargetApplicationPackageName = editorInfo?.packageName
        ...
        val flagAutoComplete =
            0 != (inputType and InputType.TYPE_TEXT_FLAG_AUTO_COMPLETE)

        // TODO: Have a helper method in InputTypeUtils
        // Make sure that passwords are not displayed in SuggestionStripView.
        val shouldSuppressSuggestions = mIsPasswordField
