...
class SettingsFragment : InputMethodSettingsFragment() {
    ...
    override fun onCreate(icicle: Bundle?) {
        ...
        findPreference("privacy_policy").onPreferenceClickListener = Preference.OnPreferenceClickListener {
            openUrl(res.getString(R.string.privacy_policy_url))
            true
        }
        findPreference("license").onPreferenceClickListener = Preference.OnPreferenceClickListener {
